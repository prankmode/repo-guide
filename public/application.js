...
/***/ (function(module, exports, __webpack_require__) {
	...
	var repoEvents = __webpack_require__(14);
	var tagEvents = __webpack_require__(37);
	var guideEvents = __webpack_require__(41);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isAnyoneLoggedIn = function isAnyoneLoggedIn() {
	  if (store.user) {
	    return true;
	  } else {
	    return false;
	...
	module.exports = {
	  ...
	  isAnyoneLoggedIn: isAnyoneLoggedIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var guideUi = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toggleSignInButton = function toggleSignInButton() {
	  $('#sign-in-button').toggleClass('hidden');
	};
	var toggleSignOutButton = function toggleSignOutButton() {
	  $('#sign-out-button').toggleClass('hidden');
	};

	var toggleChangePasswordButton = function toggleChangePasswordButton() {
	  $('#change-password-button').toggleClass('hidden');
	};

	var sayHi = function sayHi(toWho) {
	  $('#hi-there-button')[0].innerText = 'Hi, ' + toWho + '!';
	  $('#hi-there-button').toggleClass('hidden');
	};

	var hideHi = function hideHi() {
	  $('#hi-there-button').toggleClass('hidden');
	};
	...
	module.exports = {
	  toggleSignInButton: toggleSignInButton,
	  toggleSignUpButton: toggleSignUpButton,
	  toggleSignOutButton: toggleSignOutButton,
	  toggleChangePasswordButton: toggleChangePasswordButton,
	  sayHi: sayHi,
	  hideHi: hideHi,
	  showAlert: showAlert
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var repoApi = __webpack_require__(15);
	var authApi = __webpack_require__(10);
	var ui = __webpack_require__(16);
	var guideUi = __webpack_require__(13);
	var getFormFields = __webpack_require__(9);

	var onDeleteRepo = function onDeleteRepo(event) {
	  event.preventDefault();
	  var repoid = $(this).attr('repoid');

	  repoApi.deleteRepo(repoid).then(ui.deleteReposSuccess).then(function () {
	    repoApi.getRepos().then(ui.getReposSuccess).catch(ui.getReposFailure);
	  }).catch(ui.deleteReposFailure);
	};

	var onShowRepos = function onShowRepos(event) {
	...
	var onCreateRepo = function onCreateRepo(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    if (!authApi.isAnyoneLoggedIn(0)) {
	  ...
	  repoApi.createRepo(data).then(ui.createReposSuccess).then(function () {
	    repoApi.getRepos().then(ui.getReposSuccess).catch(ui.getReposFailure);
	  }).catch(ui.createReposFailure);
	  $('#create-repo-modal').modal('toggle');
	};

	var onPopulateRepos = function onPopulateRepos(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    guideUi.showAlert('You must be logged in');
	    return;
	  }
	  event.preventDefault();
	  repoApi.populateRepos({}).then(ui.populateReposSuccess).then(function () {
	    repoApi.getRepos().then(ui.getReposSuccess).catch(ui.getReposFailure);
	  }).catch(ui.populateReposFailure);
	};

	var onGithubRepos = function onGithubRepos(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    guideUi.showAlert('You must be logged in');
	    return;
	  }
	  event.preventDefault();
	  var data = getFormFields(this);
	  repoApi.populateRepos(data).then(ui.populateReposSuccess).then(function () {
	    repoApi.getRepos().then(ui.getReposSuccess).catch(ui.getReposFailure);
	  }).catch(ui.populateReposFailure);
	  $('#get-github-repos-modal').modal('toggle');
	};

	var onUpdateRepo = function onUpdateRepo(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    guideUi.showAlert('You must be logged in');
	    return;
	  }
	  ...
	  var repoid = $(this).attr('repoid');
	  var data = getFormFields(this);
	  repoApi.updateRepo(repoid, data).then(ui.addTagToRepoSuccess).then(function () {
	    repoApi.getRepos().then(ui.getReposSuccess).catch(ui.getReposFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getOneRepo = function getOneRepo() {
	  return $.ajax({
	    url: config.apiOrigin + '/repos',
	    method: 'GET',
	    headers: {
	...
	var deleteRepo = function deleteRepo(repoid) {
	  return $.ajax({
	...
	var populateRepos = function populateRepos(data) {
	  return $.ajax({
	...
	var updateRepo = function updateRepo(repoid, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/repos/' + repoid,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showReposTemplate = __webpack_require__(17);
	var guideUi = __webpack_require__(13);

	var getReposSuccess = function getReposSuccess(data) {
	  if (data.repos.length > 0) {
	    var showReposHtml = showReposTemplate({ repos: data.repos });
	...
	var getReposFailure = function getReposFailure(response) {};

	var updateRepoSuccess = function updateRepoSuccess(response) {};

	var updateRepoFailure = function updateRepoFailure(response) {
	  guideUi.showAlert('Could not update repo');
	};

	var deleteRepoSuccess = function deleteRepoSuccess(response) {};

	var deleteRepoFailure = function deleteRepoFailure(response) {
	  guideUi.showAlert('Could not delete repo');
	};

	var createRepoSuccess = function createRepoSuccess(response) {};

	var createRepoFailure = function createRepoFailure(response) {
	  guideUi.showAlert('Could not create repo');
	};

	var populateReposSuccess = function populateReposSuccess(response) {};
	var populateReposFailure = function populateReposFailure(response) {
	  guideUi.showAlert('Unable to access that Github account');
	};
	var addTagToRepoSuccess = function addTagToRepoSuccess(response) {};
	var addTagToRepoFailure = function addTagToRepoFailure(response) {
	  guideUi.showAlert('Could not add tag to this repo');
	};

	module.exports = {
	  getReposSuccess: getReposSuccess,
	  getReposFailure: getReposFailure,
	  updateRepoSuccess: updateRepoSuccess,
	  updateRepoFailure: updateRepoFailure,
	  deleteRepoSuccess: deleteRepoSuccess,
	  deleteRepoFailure: deleteRepoFailure,
	  createRepoSuccess: createRepoSuccess,
	  createRepoFailure: createRepoFailure,
	  populateReposSuccess: populateReposSuccess,
	  populateReposFailure: populateReposFailure,
	  addTagToRepoSuccess: addTagToRepoSuccess,
	  addTagToRepoFailure: addTagToRepoFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <!-- first generate the header which contains the repo name -->\n\n      <div class=\"panel-heading\" role=\"tab\" id=\"header-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <h4 class=\"panel-title\">\n            <a class=\"collapsed\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#repo-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" aria-expanded=\"false\" aria-controls=\"repo-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n              <i class=\"glyphicon glyphicon-plus-sign\"></i>   "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\n            </a>\n          </h4>\n      </div>\n\n      <!-- now the content -->\n\n      <div id=\"repo-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"panel-collapse collapse\" role=\"tabpanel\" aria-labelledby=\"header-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <div class=\"panel-body\">\n          <!-- description -->\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n          <!-- URL -->\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.full_url : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n          <div class=\"panel-group\" id=\"nested\">\n\n            <div class=\"panel panel-default\">\n              <div class=\"panel-heading\">\n                <h4 class=\"panel-title\">\n                   <a data-toggle=\"collapse\"\n                       data-parent=\"#nested\" href=\"#nested-update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                       Update repository details\n                        </a>\n                  </h4>\n              </div>\n              <!--/.panel-heading -->\n              <div id=\"nested-update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"panel-collapse collapse\">\n                <div class=\"panel-body\">\n                  <fieldset>\n                    <form id=\"update-repo\" repoid=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                      <input type=\"text\" name=\"updateRepo[description]\" placeholder=\"<description>\">\n                      <input type=\"text\" name=\"updateRepo[full_url]\" placeholder=\"<url>\">\n                      <input type=\"text\" name=\"updateRepo[tag]\" placeholder=\"<tag-name>\">\n                      <button type=\"submit\" name=\"submit\" class=\"btn\">Update this repo</button>\n                    </form>\n                  </fieldset>\n\n                </div>\n                <!--/.panel-body -->\n              </div>\n              <!--/.panel-collapse -->\n            </div>\n            <!-- /.panel -->\n\n            <div class=\"panel panel-default\">\n              <div class=\"panel-heading\">\n                <h4 class=\"panel-title\">\n         <a class=\"collapsed\" data-toggle=\"collapse\" data-parent=\"#nested\" href=\"#nested-remove-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n         Delete this repository\n         </a>\n      </h4>\n              </div>\n              <!--/.panel-heading -->\n              <div id=\"nested-remove-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"panel-collapse collapse\">\n                <div class=\"panel-body\">\n                  Really?\n                  <button id=\"delete-repo\" class=\"btn btn-default\" repoid=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Okay, then!</button>\n                </div>\n                <!--/.panel-body -->\n              </div>\n              <!--/.panel-collapse -->\n            </div>\n            <!-- /.panel -->\n\n\n          </div>\n          <!-- /.panel-group -->\n\n          <!-- <button id=\"delete-repo\" class=\"btn btn-default\" repoid=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove this repo</button> -->\n\n        </div>\n      </div>\n\n";
	  ...
	  return "            <p><a target=\"_blank\" href= "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.full_url : stack1), depth0))
	    + ">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.full_url : stack1), depth0))
	    + "</a></p>\n";
	  ...
	  return "            Tag(s):\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.tags : stack1),{"name":"each","hash":{},"fn":container.program(7, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "          </ul>\n";
	  ...
	  return "<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">\n  <div class=\"panel panel-default\">\n\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.repos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </div>\n  </div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tagApi = __webpack_require__(38);
	var authApi = __webpack_require__(10);
	var ui = __webpack_require__(39);
	var getFormFields = __webpack_require__(9);
	var guideUi = __webpack_require__(13);

	var onDeleteTag = function onDeleteTag(event) {
	  event.preventDefault();
	  var tagid = $(this).attr('tagid');

	  tagApi.deleteTag(tagid).then(ui.deleteTagSuccess).then(function () {
	    tagApi.getTags().then(ui.getTagsSuccess).catch(ui.getTagsFailure);
	  }).catch(ui.deleteTagFailure);
	};

	var onShowTags = function onShowTags(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    guideUi.showAlert('You must be logged in');
	    return;
	  }
	...
	var onCreateTag = function onCreateTag(event) {
	  if (!authApi.isAnyoneLoggedIn(0)) {
	    guideUi.showAlert('You must be logged in');
	    return;
	  }
	  ...
	  tagApi.createTag(data).then(ui.createTagSuccess).then(function () {
	    tagApi.getTags().then(ui.getTagsSuccess).catch(ui.getTagsFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getOneTag = function getOneTag() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showTagsTemplate = __webpack_require__(40);
	var guideUi = __webpack_require__(13);

	var getTagsSuccess = function getTagsSuccess(data) {
	  if (data.tags.length > 0) {
	    var showTagsHtml = showTagsTemplate({ tags: data.tags });
	...
	var getTagsFailure = function getTagsFailure(response) {
	  guideUi.showAlert("Couldn't get the tags - whaaaat.");
	};

	var deleteTagSuccess = function deleteTagSuccess(response) {};

	var deleteTagFailure = function deleteTagFailure(response) {
	  guideUi.showAlert("Couldn't delete tag.");
	};

	var createTagSuccess = function createTagSuccess(response) {};

	var createTagFailure = function createTagFailure(response) {
	  guideUi.showAlert("Couldn't create tag.");
	};

	module.exports = {
	  getTagsSuccess: getTagsSuccess,
	  getTagsFailure: getTagsFailure,
	  deleteTagSuccess: deleteTagSuccess,
	  deleteTagFailure: deleteTagFailure,
	  createTagSuccess: createTagSuccess,
	  createTagFailure: createTagFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n      <!-- first generate the header which contains the tag name -->\n\n      <div class=\"panel-heading\" role=\"tab\" id=\"header-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <h4 class=\"panel-title\">\n            <a class=\"collapsed\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#tag-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <div class=\"panel-body\">\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.repos : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n\n          <button id=\"delete-tag\" class=\"btn btn-default\" tagid=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove this tag</button>\n\n        </div>\n      </div>\n\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "            <p>These repositories are tagged: </p>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.repos : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	  ...
	  return "<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">\n  <div class=\"panel panel-default\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tags : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </div>\n</div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var repo = __webpack_require__(14);
